...
InitMenu:
	...
	global tServerNames := {}
	tServerNames[1] := {1:{name:"Ashbringer",x:9795,y:192},2:{name:"Earthshaker",x:9795,y:212},3:{name:"Firemaw",x:9795,y:232},4:{name:"Gehennas",x:9795,y:252},5:{name:"Giantstalker",x:9795,y:272},6:{name:"Golemagg",x:9795,y:292},7:{name:"Hydraxian_Waterlords",x:9795,y:312},8:{name:"Mirage_Raceway",x:9795,y:332},9:{name:"Mograine",x:9795,y:352},10:{name:"Nethergarde_Keep",x:9795,y:372},11:{name:"Pyrewood_Village",x:9795,y:392},12:{name:"Shazzrah",x:9795,y:412},13:{name:"Thekal",x:9795,y:432}}
